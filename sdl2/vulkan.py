...
SDL_Vulkan_GetInstanceExtensions = _bind("SDL_Vulkan_GetInstanceExtensions", [_P(SDL_Window), _P(c_uint), _P(c_char_p)], SDL_bool, added='2.0.6')
SDL_Vulkan_CreateSurface = _bind("SDL_Vulkan_CreateSurface", [_P(SDL_Window), VkInstance, _P(VkSurfaceKHR)], SDL_bool, added='2.0.6')
SDL_Vulkan_GetDrawableSize = _bind("SDL_Vulkan_GetDrawableSize", [_P(SDL_Window), _P(c_int), _P(c_int)], None, added='2.0.6')
