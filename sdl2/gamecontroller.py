...
SDL_GameControllerMapping = _bind("SDL_GameControllerMapping", [_P(SDL_GameController)], c_char_p)
...
SDL_GameControllerOpen = _bind("SDL_GameControllerOpen", [c_int], _P(SDL_GameController))
SDL_GameControllerName = _bind("SDL_GameControllerName", [_P(SDL_GameController)], c_char_p)
SDL_GameControllerGetType = _bind("SDL_GameControllerGetType", [_P(SDL_GameController)], SDL_GameControllerType, added='2.0.12')
SDL_GameControllerGetAttached = _bind("SDL_GameControllerGetAttached", [_P(SDL_GameController)], SDL_bool)
SDL_GameControllerGetJoystick = _bind("SDL_GameControllerGetJoystick", [_P(SDL_GameController)], _P(SDL_Joystick))
...
SDL_GameControllerGetBindForAxis = _bind("SDL_GameControllerGetBindForAxis", [_P(SDL_GameController), SDL_GameControllerAxis], SDL_GameControllerButtonBind)
SDL_GameControllerHasAxis = _bind("SDL_GameControllerHasAxis", [_P(SDL_GameController), SDL_GameControllerAxis], SDL_bool, added='2.0.14')
SDL_GameControllerGetAxis = _bind("SDL_GameControllerGetAxis", [_P(SDL_GameController), SDL_GameControllerAxis], Sint16)
...
SDL_GameControllerGetBindForButton = _bind("SDL_GameControllerGetBindForButton", [_P(SDL_GameController), SDL_GameControllerButton], SDL_GameControllerButtonBind)
SDL_GameControllerHasButton = _bind("SDL_GameControllerHasButton", [_P(SDL_GameController), SDL_GameControllerButton], SDL_bool, added='2.0.14')
SDL_GameControllerGetButton = _bind("SDL_GameControllerGetButton", [_P(SDL_GameController), SDL_GameControllerButton], Uint8)
SDL_GameControllerGetNumTouchpads = _bind("SDL_GameControllerGetNumTouchpads", [_P(SDL_GameController)], c_int, added='2.0.14')
SDL_GameControllerGetNumTouchpadFingers = _bind("SDL_GameControllerGetNumTouchpadFingers", [_P(SDL_GameController), c_int], c_int, added='2.0.14')
SDL_GameControllerGetTouchpadFinger = _bind("SDL_GameControllerGetTouchpadFinger", [_P(SDL_GameController), c_int, c_int, _P(Uint8), _P(c_float), _P(c_float), _P(c_float)], c_int, added='2.0.14')
SDL_GameControllerHasSensor = _bind("SDL_GameControllerHasSensor", [_P(SDL_GameController), SDL_SensorType], SDL_bool, added='2.0.14')
SDL_GameControllerSetSensorEnabled = _bind("SDL_GameControllerSetSensorEnabled", [_P(SDL_GameController), SDL_SensorType, SDL_bool], c_int, added='2.0.14')
SDL_GameControllerIsSensorEnabled = _bind("SDL_GameControllerIsSensorEnabled", [_P(SDL_GameController), SDL_SensorType], SDL_bool, added='2.0.14')
SDL_GameControllerGetSensorDataRate = _bind("SDL_GameControllerGetSensorDataRate", [_P(SDL_GameController), SDL_SensorType], c_float, added='2.0.16')
# TODO: Read how GetSensorData is implemented to figure out how the # of floats is determined
SDL_GameControllerGetSensorData = _bind("SDL_GameControllerGetSensorData", [_P(SDL_GameController), SDL_SensorType, _P(c_float), c_int], c_int, added='2.0.14')
SDL_GameControllerAddMappingsFromRW = _bind("SDL_GameControllerAddMappingsFromRW", [_P(SDL_RWops), c_int], c_int)
SDL_GameControllerAddMappingsFromFile = lambda fname: SDL_GameControllerAddMappingsFromRW(SDL_RWFromFile(fname, b"rb"), 1)
SDL_GameControllerFromInstanceID = _bind("SDL_GameControllerFromInstanceID", [SDL_JoystickID], _P(SDL_GameController), added='2.0.4')
SDL_GameControllerFromPlayerIndex = _bind("SDL_GameControllerFromPlayerIndex", [c_int], _P(SDL_GameController), added='2.0.12')
SDL_GameControllerGetPlayerIndex = _bind("SDL_GameControllerGetPlayerIndex", [_P(SDL_GameController)], c_int, added='2.0.9')
SDL_GameControllerSetPlayerIndex = _bind("SDL_GameControllerSetPlayerIndex", [_P(SDL_GameController), c_int], added='2.0.12')
SDL_GameControllerGetVendor = _bind("SDL_GameControllerGetVendor", [_P(SDL_GameController)], Uint16, added='2.0.6')
SDL_GameControllerGetProduct = _bind("SDL_GameControllerGetProduct", [_P(SDL_GameController)], Uint16, added='2.0.6')
SDL_GameControllerGetProductVersion = _bind("SDL_GameControllerGetProductVersion", [_P(SDL_GameController)], Uint16, added='2.0.6')
SDL_GameControllerGetSerial = _bind("SDL_GameControllerGetSerial", [_P(SDL_GameController)], c_char_p, added='2.0.14')
...
SDL_GameControllerRumble = _bind("SDL_GameControllerRumble", [_P(SDL_GameController), Uint16, Uint16, Uint32], c_int, added='2.0.9')
SDL_GameControllerRumbleTriggers = _bind("SDL_GameControllerRumbleTriggers", [_P(SDL_GameController), Uint16, Uint16, Uint32], c_int, added='2.0.14')
SDL_GameControllerHasLED = _bind("SDL_GameControllerHasLED", [_P(SDL_GameController)], SDL_bool, added='2.0.14')
SDL_GameControllerHasRumble = _bind("SDL_GameControllerHasRumble", [_P(SDL_GameController)], SDL_bool, added='2.0.18')
SDL_GameControllerHasRumbleTriggers = _bind("SDL_GameControllerHasRumbleTriggers", [_P(SDL_GameController)], SDL_bool, added='2.0.18')
SDL_GameControllerSetLED = _bind("SDL_GameControllerSetLED", [_P(SDL_GameController), Uint8, Uint8, Uint8], c_int, added='2.0.14')
SDL_GameControllerSendEffect = _bind("SDL_GameControllerSendEffect", [_P(SDL_GameController), c_void_p, c_int], c_int, added='2.0.16')
SDL_GameControllerClose = _bind("SDL_GameControllerClose", [_P(SDL_GameController)])
SDL_GameControllerGetAppleSFSymbolsNameForButton = _bind("SDL_GameControllerGetAppleSFSymbolsNameForButton", [_P(SDL_GameController), SDL_GameControllerButton], c_char_p, added='2.0.18')
SDL_GameControllerGetAppleSFSymbolsNameForAxis = _bind("SDL_GameControllerGetAppleSFSymbolsNameForAxis", [_P(SDL_GameController), SDL_GameControllerAxis], c_char_p, added='2.0.18')
